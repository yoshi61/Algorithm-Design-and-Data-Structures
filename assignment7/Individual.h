...
class Individual
{
	...
	public:
		...
		Individual(std::string binary_string); //A constructor that takes in a binary string and creates a new Individual with an identical list. Note that this involves creating a new copy of the list.
		~Individual();
};
